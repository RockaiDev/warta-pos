            ...
            <>
                ...
                <section onClick={() => setOpenMenu(!openMenu)} className={`menu bg-mainColor h-full p-4 rounded-l-2xl flex flex-col items-center justify-between ${openMenu ? '' : 'translate-x-20'} absolute duration-700 z-40`}>
                    ...
                    <div className="user flex items-center justify-center flex-col">
                        ...
                        {/* <div onClick={() => setShowAddItemModal(true)} className='text-bgColor cursor-pointer mb-5 duration-700 hover:text-mainColor hover:bg-bgColor rounded-full p-2 flex items-center gap-2'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">   <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /> </svg>
