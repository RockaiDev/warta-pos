                                ...
                                <>
                                    {user.role === 'إدارة' ? (
                                        ...
                                        <>
                                            ...
                                            <li className={`${section === 'AddItem' ? "text-mainColor text-xl bg-bgColor" : "text-bgColor"} cursor-pointer mb-2 duration-700 hover:text-mainColor hover:bg-bgColor rounded-full p-2 flex items-center gap-2`} onClick={() => setSection('AddItem')}>
                                                {/* أيقونة world */}
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 0c2.21 0 4 4.03 4 9s-1.79 9-4 9-4-4.03-4-9 1.79-9 4-9zm0 0v18" />
                                                </svg>
