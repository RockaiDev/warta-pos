                                ...
                                <>
                                    {user.role === 'إدارة' ? (
                                        ...
                                        <>
                                            ...
                                            <li className={`${section === 'WebOrders' ? "text-mainColor text-xl bg-bgColor" : "text-bgColor"} cursor-pointer mb-8 duration-700 hover:text-mainColor hover:bg-bgColor rounded-full p-2`} onClick={() => setSection('WebOrders')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
